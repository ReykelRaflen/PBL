...
Route::prefix('admin')->group(function () {
    ...
    Route::middleware('auth')->group(function () {
        ...
        // Laporan Penerbitan Kolaborasi
        Route::resource('laporan-penerbitan-kolaborasi', LaporanPenerbitanKolaborasiController::class, [
            'names' => [
                'index' => 'admin.laporanPenerbitanKolaborasi.index',
                'create' => 'admin.laporanPenerbitanKolaborasi.create',
                'store' => 'admin.laporanPenerbitanKolaborasi.store',
                'show' => 'admin.laporanPenerbitanKolaborasi.show',
                'edit' => 'admin.laporanPenerbitanKolaborasi.edit',
                'update' => 'admin.laporanPenerbitanKolaborasi.update',
                'destroy' => 'admin.laporanPenerbitanKolaborasi.destroy',
            ]
        ]);

        // Download routes untuk laporan kolaborasi
        Route::get('laporan-penerbitan-kolaborasi/{laporan}/download-naskah/{naskah}', [LaporanPenerbitanKolaborasiController::class, 'downloadNaskah'])
            ->name('admin.laporanPenerbitanKolaborasi.downloadNaskah');
        Route::get('laporan-penerbitan-kolaborasi/{laporan}/download-all', [LaporanPenerbitanKolaborasiController::class, 'downloadAllNaskah'])
            ->name('admin.laporanPenerbitanKolaborasi.downloadAll');

        // Buku Kolaboratif Management
        Route::resource('buku-kolaboratif', App\Http\Controllers\Admin\BukuKolaboratifController::class, [
            'names' => [
                'index' => 'admin.buku-kolaboratif.index',
                'create' => 'admin.buku-kolaboratif.create',
                'store' => 'admin.buku-kolaboratif.store',
                'show' => 'admin.buku-kolaboratif.show',
                'edit' => 'admin.buku-kolaboratif.edit',
                'update' => 'admin.buku-kolaboratif.update',
                'destroy' => 'admin.buku-kolaboratif.destroy',
            ]
        ]);
