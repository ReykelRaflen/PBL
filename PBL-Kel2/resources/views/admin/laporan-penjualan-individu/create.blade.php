    ...
    <div class="bg-white dark:bg-gray-800 shadow rounded-lg">
        <div class="p-6">
            <div class="flex justify-between items-center mb-6">
                <h1 class="text-2xl font-bold">Tambah Laporan Penjualan Individu</h1>
            ...
            <form action="{{ route('admin.laporan-penjualan-individu.store') }}" method="POST">
                @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <select name="status_pembayaran" id="status_pembayaran" required
                            ...
                            <option value="menunggu_verifikasi" {{ old('status_pembayaran') == 'menunggu_verifikasi' ? 'selected' : '' }}>Menunggu Verifikasi</option>
                            <option value="sukses" {{ old('status_pembayaran') == 'sukses' ? 'selected' : '' }}>Sukses</option>
                            <option value="tidak_sesuai" {{ old('status_pembayaran') == 'tidak_sesuai' ? 'selected' : '' }}>Tidak Sesuai</option>
                        </select>
                ...
                <div class="mt-6">
                    ...
                    <input type="text" name="bukti_pembayaran" id="bukti_pembayaran" value="{{ old('bukti_pembayaran') }}"
                        ...
                        placeholder="Contoh: bukti_pembayaran/file.jpg" readonly>
                    @error('bukti_pembayaran')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                    <p class="text-xs text-gray-500 mt-1">Otomatis terisi dari data penerbitan yang dipilih</p>
                </div>

                <div class="mt-6 p-4 bg-blue-50 dark:bg-blue-900 rounded-lg">
                    <h4 class="text-sm font-medium text-blue-800 dark:text-blue-200 mb-2">Informasi:</h4>
                    <ul class="text-xs text-blue-700 dark:text-blue-300 space-y-1">
                        <li>• Invoice akan dibuat otomatis berdasarkan nomor pesanan</li>
                        <li>• Data akan terisi otomatis saat memilih penerbitan individu</li>
                        <li>• Hanya penerbitan dengan status pembayaran "pending" yang ditampilkan</li>
                    </ul>
                </div>
