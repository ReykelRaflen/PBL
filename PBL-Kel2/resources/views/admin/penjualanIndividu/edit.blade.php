...
@section('main')
<div class="container">
    <h2 class="text-2xl font-bold mb-4 text-center">Edit Laporan Penjualan Buku Individu</h2>
    ...
    <form action="{{ route('penjualanIndividu.update', $laporan->id) }}" method="POST" class="space-y-4">
        @csrf
        @method('PUT')
