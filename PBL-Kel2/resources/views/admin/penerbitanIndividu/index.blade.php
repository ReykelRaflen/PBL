    ...
    <div class="bg-white dark:bg-gray-800 shadow rounded-lg">
        <div class="p-6">
            <div class="flex justify-between items-center mb-6">
                <h1 class="text-2xl font-bold text-gray-900 dark:text-gray-100">Laporan Penerbitan Buku Individu</h1>
                <a href="{{ route('admin.penerbitanIndividu.create') }}"
            ...
            <div class="grid grid-cols-2 md:grid-cols-5 gap-4 mb-6">
                ...
                <div class="bg-green-50 dark:bg-green-900 p-4 rounded-lg">
                    <div class="text-green-600 dark:text-green-300 text-sm font-medium">Terbit</div>
                    <div class="text-2xl font-bold text-green-900 dark:text-green-100">{{ $statistik['terbit'] }}</div>
                </div>
                <div class="bg-yellow-50 dark:bg-yellow-900 p-4 rounded-lg">
                    <div class="text-yellow-600 dark:text-yellow-300 text-sm font-medium">Proses</div>
                    <div class="text-2xl font-bold text-yellow-900 dark:text-yellow-100">{{ $statistik['proses'] }}</div>
                </div>
                <div class="bg-orange-50 dark:bg-orange-900 p-4 rounded-lg">
                    <div class="text-orange-600 dark:text-orange-300 text-sm font-medium">Pending</div>
                    <div class="text-2xl font-bold text-orange-900 dark:text-orange-100">{{ $statistik['pending'] }}</div>
                </div>
                <div class="bg-purple-50 dark:bg-purple-900 p-4 rounded-lg">
                    <div class="text-purple-600 dark:text-purple-300 text-sm font-medium">Dengan ISBN</div>
                    <div class="text-2xl font-bold text-purple-900 dark:text-purple-100">{{ $statistik['dengan_isbn'] }}
                    </div>
                </div>
            </div>
                ...
                <form method="GET" class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div>
                        ...
                        <input type="text" name="search" value="{{ request('search') }}"
                            placeholder="Kode, Judul, Penulis, ISBN..."
                            class="w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white focus:border-blue-500 focus:ring-blue-500">
                    </div>
                            ...
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-400">
                                    @if($laporan->penerbitanIndividu)
                                        ...
                                        <div class="text-xs text-gray-400">{{ $laporan->penerbitanIndividu->nomor_pesanan }}</div>
                                    @else
                                        <div class="flex items-center">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    <div class="flex items-center space-x-2">
                                        ...
                                        <form action="{{ route('admin.penerbitanIndividu.destroy', $laporan->id) }}"
                            ...
                            <tr>
                                <td colspan="7"
                                    ...
                                    <div class="flex flex-col items-center justify-center py-8">
                                        ...
                                        <p class="text-lg font-medium text-gray-900 dark:text-gray-100 mb-2">Belum ada laporan
                                        </p>
                                        <p class="text-sm text-gray-500 dark:text-gray-400">Laporan penerbitan akan muncul di
                                            sini</p>
                                    </div>
                                </td>
                            </tr>
