                ...
                <div class="bg-gray-50 dark:bg-gray-700 px-6 py-4 border-t border-gray-200 dark:border-gray-600 rounded-b-lg">
                    <div class="flex items-center justify-between flex-wrap gap-4">
                        <div class="flex flex-wrap gap-3">
                            ...
                            <button onclick="copyBookLink()" class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-lg shadow text-sm font-medium transition-colors flex items-center">
